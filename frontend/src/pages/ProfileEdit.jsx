    ...
    return (
        <main className="grow pb-20 px-6">
            <div className="max-w-2xl mx-auto">
                ...
                <div
                    className="mt-12 p-6 bg-secondary-fixed border-l-4 border-secondary rounded-r-lg"
                >
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <p
                                className="text-sm text-on-secondary-fixed-variant leading-relaxed"
                            >
                                Tu nombre y biografía serán visibles para otros usuarios. No
                                compartas información sensible como direcciones o contraseñas en
                                tu biografía.
                            </p>
                        </div>
                    </div>
