    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden transform transition-all">
        ...
        <div className="px-8 py-6 flex justify-between items-center border-b border-slate-100">
          <h2 className="title-md text-slate-900">
        ...
        <form id="user-form" className="p-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            <label className="block label-md text-slate-500 uppercase tracking-widest mb-2">
              Nombre completo
            </label>
            <input
          ...
          <div>
            <label className="block label-md text-slate-500 uppercase tracking-widest mb-4">
              Selector de rol
            </label>
