...
export default function FormRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/login", {
        state: { successMessage: "Cuenta creada. ¡Ya podés iniciar sesión!" },
      });
    } catch (err) {
  ...
  return (
    <form className="px-8 pb-10 flex flex-col gap-5" onSubmit={handleSubmit} noValidate>
      <div className="space-y-1.5">
        ...
        {errors.username && (
          <span className="text-sm font-small ml-1 text-error">{errors.username}</span>
        )}
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          />
          {errors.email && (
            <span className="text-sm font-small ml-1 text-error">{errors.email}</span>
          )}
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          />
          {errors.password && (
            <span className="text-sm font-small ml-1 text-error">{errors.password} </span>
          )}
        </div>
      ...
      <div className="space-y-1.5">
        <label className="text-sm font-medium text-slate-700 ml-1" htmlFor="confirm-password">
        ...
        <div className="relative">
          ...
          {errors.confirm_password && (
            <span className="text-sm font-small  ml-1 text-error">{errors.confirm_password} </span>
          )}
        </div>
